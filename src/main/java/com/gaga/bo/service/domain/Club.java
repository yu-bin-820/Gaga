...
public class Club {
	...
	public String toString() {
		return String.format(
				"Club [clubNo=%s, clubName=%s, clubIntro=%s, clubLeaderNo=%s, clubMaxMemberNo=%s, clubRegDate=%s, clubState=%s, clubImg=%s, clubRegion=%s, filterGender=%s, filterMinAge=%s, filterMaxAge=%s, filterTag=%s, mainCategoryNo=%s, state=%s, memberCount=%s, parentClubNo=%s, parentMeetingNo=%s]",
				clubNo, clubName, clubIntro, clubLeaderNo, clubMaxMemberNo, clubRegDate, clubState, clubImg, clubRegion,
				filterGender, filterMinAge, filterMaxAge, filterTag, mainCategoryNo, state, memberCount, parentClubNo,
				parentMeetingNo);
	}
