...
const SelectGender = ({ onGenderClick }) => {
  ...
  return (
    <div>
      <Stack sx={{ marginLeft: 1 }} spacing={2}>
        <Stack
          direction='row'
          alignItems='center'
          spacing={2}
          sx={{
            marginLeft: 1,
            marginRight: 1.5,
            borderBottom: '1.5px solid #bfbdbd',
          }}
        >
          <WcIcon />
          <h4>성별</h4>
        ...
        <Stack direction='row' alignItems='center' sx={{ marginLeft: 1 }}>
          <StyledToggleButtonGroup
            ...
            sx={{ marginLeft: 2 }}
          >
            <ToggleButton value='0' onClick={() => onClickGender('0')}>
              누구나
            </ToggleButton>
            {myData.gender == '1' && (
              <ToggleButton value='1' onClick={() => onClickGender('1')}>
                남자만
              </ToggleButton>
            )}
            {myData.gender == '2' && (
              <ToggleButton value='2' onClick={() => onClickGender('2')}>
                여자만
              </ToggleButton>
            )}
          </StyledToggleButtonGroup>
